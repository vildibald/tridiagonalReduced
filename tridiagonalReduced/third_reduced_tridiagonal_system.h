...
class third_reduced_tridiagonal_system : public reduced_tridiagonal_system
{
protected:
...
public:
	...
	explicit third_reduced_tridiagonal_system(standard_tridiagonal_system tridiagonal_system);
