...
class second_reduced_tridiagonal_system : public reduced_tridiagonal_system
{
protected:
...
public:
	...
	explicit second_reduced_tridiagonal_system(standard_tridiagonal_system tridiagonal_system);
